...
//   $('.resultContainer').html('');
  $.ajax({
    type: "GET",
    async: false,
    url: "https://api.nutritionix.com/v1_1/search"+userInput+"?"+"fields=item_name%2Citem_id%2Cbrand_name%2Cnf_calories%2Cnf_total_fat&appId=2a67dbb4&appKey=eab1d2899f63f45de8177c6e513b443a",
    success: function(d) {
